...
(function (factory) {
    ...
    function ScrollToDo(ops) {
        ...
        root.getDirection = function () {
            ...
            if (scrolls.scrollTop - lastScrollTop > 0) {
                Y = 1;
            }
            else if (scrolls.scrollTop - lastScrollTop < 0) {
                Y = -1;
            }
            if (scrolls.scrollLeft - lastScrollLeft > 0) {
                X = 1;
            }
            else if (scrolls.scrollLeft - lastScrollLeft < 0) {
                X = -1;
            }
            setTimeout(function () {
                scroller.lastScrollTop = scrolls.scrollTop;
                scroller.lastScrollLeft = scrolls.scrollLeft;
            }, 0);
